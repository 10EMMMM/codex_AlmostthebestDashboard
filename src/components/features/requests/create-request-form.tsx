...
import { CalendarIcon, MapPin, User, Check, ChevronsUpDown } from "lucide-react";
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-3">
            ...
            <Input
                ...
                placeholder="e.g., New Italian Restaurant in Downtown"
            />
        </div>
            ...
            <Popover>
                <PopoverTrigger asChild>
                    ...
                    >
                        ...
                        {formData.deadline ? format(formData.deadline, "PPP") : "Pick date"}
                    </Button>
                </PopoverTrigger>
